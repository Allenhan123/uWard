...
import com.ygxinjian.anhui.youwardrobe.Activity.ProductPingActivity;
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                iv_img.setImageResource(R.drawable.iv_take_photo);
                clickPosition = ProductPingActivity.IMAGE_ITEM_ADD;
            } else {
