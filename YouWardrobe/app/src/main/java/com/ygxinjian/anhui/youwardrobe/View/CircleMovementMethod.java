...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = YouWardrobeApplication.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = YouWardrobeApplication.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
