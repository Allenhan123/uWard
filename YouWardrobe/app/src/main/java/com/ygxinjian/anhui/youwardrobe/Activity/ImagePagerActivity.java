...
//      沉浸式状态栏
        StatusBarUtils.setWindowStatusBarColor(this, R.color.white_2);
    ...
    private static class ImageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View view = inflater.inflate(R.layout.item_pager_images, container, false);
            if(view != null){
                final ImageView imageView = (ImageView) view.findViewById(R.id.vp_images);
